...
BEGIN
    ...
    EXECUTE IMMEDIATE 'DROP SEQUENCE seq_bookmarks';
EXCEPTION
    WHEN OTHERS THEN
        NULL;
END;
...
CREATE TABLE bookmarks (
    ...
    CONSTRAINT unique_bookmark UNIQUE (user_id, book_id)
);
...
CREATE OR REPLACE TRIGGER trg_bookmarks
BEFORE INSERT ON bookmarks
FOR EACH ROW
BEGIN
    :NEW.bookmark_id := seq_bookmarks.NEXTVAL;
END;
/
